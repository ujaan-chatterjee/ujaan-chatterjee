...
| [**sentiment-twitter-dashboard**](https://github.com/ujaan-chatterjee/sentiment-twitter-dashboard) | Real-time NLP sentiment analysis dashboard for Twitter with BERT transformers and interactive visualization | Python · NLTK · Transformers/BERT · Streamlit · Plotly · Data 
| [**smart-garden-management-system**](https://github.com/ujaan-chatterjee/smart-garden-management-system) | IoT-based garden automation system featuring real-time soil monitoring, automated irrigation, and plant care recommendations | React Native · Node.js · MongoDB · MQTT · IoT (ESP32) · AWS | Intermediate-level academic project (Term-4, CAP314) for demonstrating full-stack IoT application development |wrangling · Ethical AI |Jupyter notebooks · reproducible workflows |
